        ...
        <div className="mxd-block">
          ...
          <div className="mxd-container">
            <div className="mxd-demo-components">
              ...
              <p className="mxd-demo-components__title anim-uni-in-up">
                Experience a selection of Knights from across the color and
                texture families. Each render highlights the detailed materials,
                precise modeling, and bold colors that define the Digital
                Knights universe.
              </p>
            </div>
          </div>
