                ...
                <div className="row g-0">
                  <div className="col-12 col-xl-6 mxd-grid-item no-margin">
                    <div className="hero-02-static__caption loading__item">
                      ...
                      <p
                        className="t-large t-medium t-120 t-muted"
                        style={{ fontSize: 25, marginTop: 10 }}
                      >
                        A next-generation sci-fi universe where color, identity,
                        and craftsmanship define every Knight.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mxd-hero-02-marquee__line loading__item">
                ...
                >
                  ...
                  <div className="marquee__item one-line item-regular text">
                    <p className="marquee__text">Built to Stand Out</p>
                        ...
                        <div className="row g-0">
                          <div className="col-6 col-xl-5">
                            <ul>
                              ...
                              <li>
                                <p className="t-small anim-uni-in-up">Ideas</p>
                              </li>
                              <li>
                                <p className="t-small anim-uni-in-up">Colors</p>
                              </li>
                              <li>
                                <p className="t-small anim-uni-in-up">
                                  Passion
                          ...
                          <div className="col-6 col-xl-5">
                            <ul>
                              ...
                              <li>
                                <p className="t-small anim-uni-in-up">Design</p>
                              </li>
                              <li>
                                <p className="t-small anim-uni-in-up">
                                  Persistance
